...
simulation.beta = importdata('dcm/confounding_effects_beta.txt');
%simulation.X0 = ones(size(bold_response.true,1),1);

% true bold responses
bold_response.true = bold_signal_change_eqn(simulation.state{:,{'v_1','v_3','v_2'}},...
    simulation.state{:,{'q_1','q_3','q_2'}}) + simulation.X0 * simulation.beta;
