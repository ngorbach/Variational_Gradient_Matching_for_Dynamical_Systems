...
from proxies_for_ode_parameters_and_states_LV import *
...
simulation.observed_states = sym.symbols(['x_1','x_2'])
...
time_points.for_estimation = np.arange(0,4.0,0.1)
