...
kernel.param = [10,0.5];                                                   % set values of rbf kernel parameters
%%
...
%% Posterior for Individual States
%
...
path_ode = './ODEs.txt';                                                   % path to system of ODEs
