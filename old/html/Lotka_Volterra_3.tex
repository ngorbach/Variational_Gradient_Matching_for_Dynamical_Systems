...
\includegraphics [width=4in]{Lotka_Volterra_3_05.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_06.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_07.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_08.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_09.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_10.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_11.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_12.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_13.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_14.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_15.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_16.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_17.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_18.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_19.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_20.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_21.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_22.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_23.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_24.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_25.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_26.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_27.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_28.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_29.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_30.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_31.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_32.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_33.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_34.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_35.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_36.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_37.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_38.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_39.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_40.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_41.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_42.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_43.eps}

\includegraphics [width=4in]{Lotka_Volterra_3_44.eps}
\begin{par}
...
\includegraphics [width=4in]{Lotka_Volterra_3_45.eps}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}time taken: 51.19 seconds
\end{verbatim} \color{black}
...
\includegraphics [width=4in]{Lotka_Volterra_3_04.eps}
\begin{par}
...
\includegraphics [width=4in]{Lotka_Volterra_3_01.eps}
\begin{par}
ODE parameters
\end{par} \vspace{1em}
\begin{verbatim}
...
\includegraphics [width=4in]{Lotka_Volterra_3_02.eps}
\begin{par}
States
\end{par} \vspace{1em}
\begin{verbatim}
...
\includegraphics [width=4in]{Lotka_Volterra_3_03.eps}
\begin{verbatim}
end
\end{verbatim}
\begin{par}
