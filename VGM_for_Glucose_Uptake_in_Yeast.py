...
from Glucose_Uptake_in_Yeast_declarations import *
...
simulation.ode_param = [0.1,0,0.4,0,0.3,0,0.7,0,0.1,0.2]
...
#simulation.observed_states = sym.symbols(['_x_Glce','_x_Glci','_x_EG6Pi','_x_EGlcG6Pi','_x_G6Pi','_x_EGlce','_x_EGlci','_x_Ee','_x_Ei'])
simulation.observed_states = sym.symbols(['_x_Glci','_x_EG6Pi','_x_EGlcG6Pi','_x_G6Pi','_x_EGlce','_x_EGlci','_x_Ee','_x_Ei'])
...
time_points.for_estimation = np.arange(0,99.0,0.5)
...
opt_settings.optimizer = 'analytical'
...
for i in range(10):
    proxy.param = proxy_for_ode_parameters(proxy.state,locally_linear_odes,dC_times_inv_C,eps_cov,symbols.param,simulation.ode_param,odes,opt_settings.ode_param_constraint,optimizer=opt_settings.optimizer)
    proxy.state = proxy_for_ind_states(proxy.state,proxy.param,odes,locally_linear_odes,dC_times_inv_C,eps_cov,state_pred_mean,state_pred_inv_cov,simulation.observations,simulation.state,state_couplings,True,optimizer='minimizer',constraints=opt_settings.state_constraint,fig_shape=fig_shape)
