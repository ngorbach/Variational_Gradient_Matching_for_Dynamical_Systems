...
\section*{Variational Gradient Matching for Dynamical Systems: Lorenz Attractor}
...
\setlength{\itemsep}{-1ex}
   ...
   \item User Input: Estimation Settings
   \item Preprocessing
...
\begin{par}
Instructional code for the NIPS (2018) paper \begin{verbatim}Scalable Variational Inference for Dynamical Systems\end{verbatim} by Nico S. Gorbach, Stefan Bauer and Joachim M. Buhmann. Please cite our paper if you use our program for a further publication. The derivations in this document are also given in the doctoral thesis \begin{verbatim}https://www.research-collection.ethz.ch/handle/20.500.11850/261734\end{verbatim} as well as in parts of Wenk et al. (2018).
\end{par} \vspace{1em}
\begin{par}
...
\begin{verbatim}               Input a row vector of real numbers of size 1 x 3:\end{verbatim}
    \begin{verbatim}
...
\subsection*{User Input: Estimation Settings}
...
\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_01.eps}
\begin{par}
start timer
\end{par} \vspace{1em}
\begin{verbatim}
...
\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_02.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_03.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_04.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_05.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_06.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_07.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_08.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_09.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_10.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_11.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_12.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_13.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_14.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_15.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_16.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_17.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_18.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_19.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_20.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_21.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_22.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_23.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_24.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_25.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_26.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_27.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_28.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_29.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_30.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_31.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_32.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_33.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_34.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_35.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_36.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_37.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_38.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_39.eps}

\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_40.eps}
\begin{par}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Error using internal.matlab.publish.PublishFigures>printSnap (line 226)
Could not write to /Users/nico/Documents/Thesis/Thesis_compact/scalable_dynamics/code_publish/html.
...
Error in internal.matlab.publish.PublishFigures.snapFigure (line 138)
                    feval([method 'Snap'],f,imgFilename,imageFormat,opts);

Error in internal.matlab.publish.PublishFigures/snap (line 57)
                imgFilename = obj.snapFigure(f,obj.options.filenameGenerator(),obj.options);

Error in internal.matlab.publish.PublishFigures/leavingCell (line 82)
...
Error in VGM_for_Lorenz_Attractor (line 510)
            [state.proxy.mean{:,symbols.state_string},state.proxy.inv_cov] = proxy_for_ind_states(state.lin_comb,...
...
\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_42.eps}
\begin{par}
...
\includegraphics [width=4in]{VGM_for_Lorenz_Attractor_43.eps}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}time taken: 89.9112 seconds
\end{verbatim} \color{black}
...
\begin{par}
Gorbach, N.S.  Validation and Inference of Structural Connectivity and Neural Dynamics with MRI data. 2018. ETH Zürich Doctoral Thesis. \begin{verbatim}https://www.research-collection.ethz.ch/handle/20.500.11850/261734\end{verbatim}.
\end{par} \vspace{1em}
\begin{par}
