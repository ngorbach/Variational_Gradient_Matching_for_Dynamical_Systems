...
simulation.numb_odes = 10;                                                 % number of ODEs
...
for u = 1:8
    ...
    if state.obs_idx(u)
        legend(h{u},{'true','observed','estimated'},'Location','southwest','FontSize',10); 
    else
        legend(h{u},{'true','estimated'},'Location','southwest','FontSize',10); 
    end
end
